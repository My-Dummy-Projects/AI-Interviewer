...
const PRICING = [
  {
    ...
    price: "$0",
    period: "forever",
    desc: "Everything you need to prepare for your next interview.",
    features: [
  ...
  },
  {
    ...
    price: "$19",
    period: "/ month",
    desc: "Deeper feedback, custom rubrics, and interview history.",
    features: [
      "Everything in Free",
  ...
  },
  {
    ...
    price: "$49",
    period: "/ seat / month",
    desc: "For bootcamps, career centers, and hiring bar-raisers.",
    features: [
      "Everything in Pro",
      "Cohort dashboards",
...
const FAQS = [
  ...
  },
  {
    ...
    a: "In the free tier, no — transcripts live only in your browser session and are gone the moment you close the tab. Pro tier (coming soon) will offer opt-in persistence so you can revisit and diff past interviews.",
  },
  {
